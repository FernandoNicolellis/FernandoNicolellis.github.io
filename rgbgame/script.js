function scope() {
    ...
    for (var c = 1; c <= 6; c++){
        document.getElementById("pos_" + c).addEventListener("click", (click) => {
            var click = click.target.id.charAt(4)
    ...
    document.querySelector(".lost").addEventListener("click", init)
    document.querySelector(".win").addEventListener("click", init)
